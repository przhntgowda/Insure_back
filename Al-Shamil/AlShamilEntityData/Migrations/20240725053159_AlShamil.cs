...
{
    /// <inheritdoc />
    public partial class AlShamil : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleAccess_Page_PageId",
                        column: x => x.PageId,
                        principalTable: "Page",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Guid = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValueSql: "NEWID()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountLedger_AccountGroup_AccountGroupId",
                        column: x => x.AccountGroupId,
                        principalTable: "AccountGroup",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AccountLedger_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountLedgerDtoId = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transaction_AccountLedger_AccountLedgerDtoId",
                        column: x => x.AccountLedgerDtoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountLedger_AccountGroupId",
                table: "AccountLedger",
                column: "AccountGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountLedger_CompanyId",
                table: "AccountLedger",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_AccountLedgerDtoId",
                table: "Transaction",
                column: "AccountLedgerDtoId");
